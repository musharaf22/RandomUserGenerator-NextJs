...
const Paginations = ({ currPage, setPageId, noOfPages, refetch }: Ipage) => {
  ...
  return (
    <div className="flex justify-between items-center bg-[#fff] py-3">
      ...
      <ReactPaginate
        ...
        activeClassName="text-[#ffff] z-10 bg-[#000000] font-bold text-[#333] inline-flex items-center  border text-sm"
        previousClassName={
          currPage === 1
